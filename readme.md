...
| LANGSMITH_TRACING_V2   | false                              | OPTIONAL - Enable Langchain tracing v2                                  |
...
> [!WARNING]
> There is a performance issue that impacts python applications in the latest release of Docker Desktop. Until a fix is available, please use [version `4.24.x`](https://docs.docker.com/desktop/release-notes/#4230) or earlier.
