...
from chains import configure_llm_only_chain, configure_qa_rag_chain
...
if submit_button and question:
    ...
    with tab2:
        with st.spinner("Fetching answer..."):
            ...
            rag_chain_neo4j = configure_qa_rag_chain(llm, embeddings, embeddings_store_url=url, username=username, password=password)
...
if custom_prompt_button and question:
    with tab4:
        with st.spinner("Fetching answers..."):
            ...
            rag_chroma_chain_custom = configure_qa_rag_chroma_chain_test(llm=llm, embeddings=embeddings, general_system_template=prompt)
